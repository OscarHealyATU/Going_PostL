...
public class PlayerMovementInside : MonoBehaviour
{
    ...
    void Update()
    {
     if(!canMove)
        ...
        // current velocity is SmoothDamped for nicer inside movement - outside uses Slerp, 
        // which has a side effect of chaotic movement when switching between forward and backward movement
        ...
        curVelocity = Vector3.Lerp(curVelocity, targetVelocity,  acceleration * Time.deltaTime);
